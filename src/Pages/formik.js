...
{/* Leader Form Group 1 */}
      <Row className="mb-5">
        <Form.Group as={Col} controlId="formGridCity">
          ...
          <Form.Control name='user' type='text' onChange={formik.handleChange} value={formik.values.user} placeholder="isi data user" />
        </Form.Group>

        <Form.Group as={Col} controlId="formGridCity">
          <Form.Label>Room Degree</Form.Label>
          <Form.Select  defaultValue="Choose..." name='room_degree' type='text' onChange={formik.handleChange} value={formik.values.room_degree}>
            <option>....</option>
            <option>21</option>
            <option>22</option>
            <option>23</option>
        ...
        <Form.Group as={Col} className="xs={7}" controlId="formGridZip">
          ...
          <Form.Control name='no_reg_old' type='text' onChange={formik.handleChange} value={formik.values.no_reg_old} />
        </Form.Group>

        <Form.Group as={Col} controlId="formGridZip">
          <Form.Label>Calibration Date</Form.Label>
          <Form.Control name='calibration_date' type='text' onChange={formik.handleChange} value={formik.values.calibration_date} />
        </Form.Group>
