...
import '../../App.css'
import DataRef  from '../../model/inputTemp.Reff'
...
function InputTempContAddModal() {
    // works
    // deklarasi state
    ...
    const nameStaff = useRef()
    const std_ds1_r2 = useRef('')
    const std_ds1_r3 = useRef('')

    const std_ds2_r1 = useRef('')
    const std_ds2_r2 = useRef('')
    const std_ds2_r3 = useRef('')

    const std_ds3_r1 = useRef('')
    const std_ds3_r2 = useRef('')
    const std_ds3_r3 = useRef('')

    const std_ds4_r1 = useRef('')
    const std_ds4_r2 = useRef('')
    const std_ds4_r3 = useRef('')

    const std_ds5_r1 = useRef('')
    const std_ds5_r2 = useRef('')
    const std_ds5_r3 = useRef('')
    ...
    // console.log("result : ", resultInput)

    return (
        <div className='container'>
            <h1 style={{ fontFamily: 'Segoe UI' }} className='mb-4 mt-4 mb-4 fw-bold'> Testing Add Modal for Confirm </h1>
            ...
            <form onSubmit={handleSubmit(onsubmit)} >
                ...
                <Row className="mb-5 border p-2">
                    <Form.Group as={Col} controlId="formGridCity">
                        ...
                        <Form.Select ref={nameStaff} id='updated_staff' defaultValue="...." {...register("updated_staff", { required: true })} placeholder="isi data suhu ruangan">
                            {staff.map(row => {
                                return (
          ...
          <Form.Control className="mb-2" {...register("updated_staff" , { required: true})}  placeholder="isi data user" />
                    ...
                    <Form.Group as={Col} controlId="formGridCity">
                        ...
                        <Form.Control onClick={onClickButton} className="mb-2" {...register("new_reg_no", { required: true })} placeholder="isi data user" />
                    </Form.Group>
                    ...
                    <Form.Group as={Col} controlId="formGridCity">
                        ...
                        <Form.Control onClick={onClickButton2} className="mb-2" {...register("machine_no", { required: true })} placeholder="No Machine" />
                    </Form.Group>
                ...
                <div>
                <Modal title="Confirmation Result"
                 open={isModalOpen} 
                 onOk={handleOk} 
                ...
                <Button variant="warning" onClick={handleSubmitModal} >Validasi </Button>
                <Button variant="primary" type="submit" style={{marginLeft:15}} disabled={isEnable} >Submit </Button>
                </div>
...
export default InputTempContAddModal
